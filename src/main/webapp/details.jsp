...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/article/getArticleInfo"><i class="icon icon-inbox"></i> <span>文章列表</span></a></li>        <li><a href="widgets.html"><i class="icon icon-inbox"></i> <span>Widgets</span></a></li>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered table-striped">
                    ...
                    <c:forEach items="${userInfoAndArticles.articleList}" var="var" >
                        <tr>
